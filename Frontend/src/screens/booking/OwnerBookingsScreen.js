...
import { getOwnerBookings, updateBookingStatus, cancelBooking } from '../../utils/api';
...
const OwnerBookingsScreen = ({ navigation }) => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      Alert.alert('Error', 'Failed to load your received bookings');
    } finally {
      setLoading(false);
    }
  };
    ...
    Alert.alert(
      ...
      [
        { text: 'No', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              // For owners, we use updateBookingStatus to cancel
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyTitle}>No Received Bookings</Text>
      <Text style={styles.emptySubtitle}>
        You haven't received any bookings for your listings yet. Make sure your listings are active and attractive!
      </Text>
      <Button
        mode="contained"
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading received bookings...</Text>
      </View>
    );
  }
